Rails.application.routes.draw do
  ...
  get ":username/pills" => "users#pills"
  get ":username/vitamins" => "users#vitamins"
  get ":username/pill_takens" => "users#pill_takens"
  get ":username/schedule" => "users#schedule"
 ...
 # get "/delete_vitamin/:path_id" => "vitamins#destroy", as: :delete_vitamin # delete_vitamin_url and delete_vitamin_path() (expects an argument to populate :id segment)
  ...
  #get "/pill/:path_id" => "pills#show", as: :pill # pill_url and pill_path() (expects an argument to populate :id segment)
