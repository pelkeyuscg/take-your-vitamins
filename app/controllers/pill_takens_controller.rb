class PillTakensController < ApplicationController
  ...
  def create
    ...
    if the_pill_taken.valid?
      the_pill_taken.save
      redirect_to("/pill_takens", { :notice => "Pill taken created successfully." })
    else
      redirect_to("/pill_takens", { :alert => the_pill_taken.errors.full_messages.to_sentence })
    end
  end
  ...
  def update
    ...
    if the_pill_taken.valid?
      the_pill_taken.save
      redirect_to("/pill_takens/#{the_pill_taken.id}", { :notice => "Pill taken updated successfully."} )
    else
      redirect_to("/pill_takens/#{the_pill_taken.id}", { :alert => the_pill_taken.errors.full_messages.to_sentence })
    end
  end
  ...
  def destroy
    ...
    redirect_to("/pill_takens", { :notice => "Pill taken deleted successfully."} )
  end
end
